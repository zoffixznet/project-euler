...
before_bump_recurse :: Integer -> [[(Integer,Integer)]]
before_bump_recurse n_COUNT = [(after_bump_recurse (count_of_elems_in_second_series_below_first_max + num_elems_in_e_series) (n_COUNT-(first_max_letter_idx+1)) (nCr first_max_letter_idx [count_of_elems_in_second_series_below_first_max, num_elems_in_e_series-1])) |
