...
before_bump_recurse_helper n_COUNT = [(after_bump_recurse (num_below_1max_in_2nd + e_elems_count) (n_COUNT-(first_max+1)) (nCr first_max [num_below_1max_in_2nd, (e_elems_count-1)])) |
